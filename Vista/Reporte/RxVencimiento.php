...
<main class="full-box main-container Blogger">
    ...
    <H1 class="text-center title Gagalin">REPORTE POR FECHA VENCIMIENTO</H1>
    ...
    <div class="table-responsive frm">
        ...
        <table class="table table-sm">
            <thead>
                <caption>REPORTE POR FECHA VENCIMIENTO</caption>
            ...
            <tbody>
                <?php
                foreach ($listaRxVencimiento as $vistaRepo) {
                ?>
