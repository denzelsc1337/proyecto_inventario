<?php
    ...
    if (isset($_POST['actuCole'])) {
        ...
        $query = "UPDATE `colegios` SET `cod_modu_colegio` = '$cod_mod', `ugel_colegio` = '$cod_ugel', 
        `nom_colegio` = '$nom_cole', `dir_colegio` = '$dir_cole', `tlf_colegio` = '$num_cole', 
        `mail_colegio` = '$email_cole', `depa_colegio` = '$dpto_cole', `prov_colegio` = '$prov_cole', 
        `dist_colegio` = '$dsto_cole', `director_colegio` = '$loc_cole', `nivel_colegio` = '$nivel_cole'
         WHERE `colegios`.`secuence_col` = '$secuence';";
